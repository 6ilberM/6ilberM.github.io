  ...
  <section className="other-projects">
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          A simple Rust CLI application for time tracking, helping those with
          time blindness keep track of time during any period. Made to learn
          Rust, a language I greatly enjoy.
        </p>
        <img
