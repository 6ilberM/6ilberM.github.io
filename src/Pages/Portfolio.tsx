...
const Portfolio = () => {
  const successfulProjectImages = [
    {
      src:
        "https://play-lh.googleusercontent.com/KFXHhPzvbJn0gi9n6txO4sXerKfYjYnpM0FUuM5zLyWOWOuWX6QSlFGL6U-MKNph7ho3=w2560-h1440-rw",
      alt: "Game screenshot",
    },
    {
      src:
        "https://play-lh.googleusercontent.com/KUSW6PkA02A7yFZm1x1sSFeL3uGTFNVxXlDo6jzfCWKblLEVLHTle0OUDVrX5lhO6zU=w2560-h1440-rw",
      alt: "Start screen",
    },
  ];
  ...
  return (
    <div className="portfolio">
      ...
      <section className="professional-projects">
        ...
        <p>
          At FiveBits, I often led projects and assisted in others. Here are
          some of them:
        </p>
